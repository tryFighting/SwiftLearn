...
class NewSwiftViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.learnArr = ["1.常用的几个高阶函数",
                         "2.高阶函数扩展",
                         "3.优雅的判断多个值中是否包含某一值",
                         "4.Hashable,Equatable和Comparable协议",
                         "5.可变参数函数",
                         "6.where关键字","switch中判断枚举类型，尽量避免使用default",
                         "7.iOS9之后全局动态修改StatusBar样式",
                         "8.使用面向协议实现app的主题功能",
                         "9.Swift中多继承的实现",
                         "10.华丽的Tableview的刷新动效",
                         "11.实现一个不基于Runtime的KVO",
                         "12.实现多重代理",
                         "13.自动检查控制器是否被销毁",
                         "14.向控制器中注入代码",
                         "15.向Extension添加存储属性",
                         ...
                         "21.最后执行的defer代码块",
                         "22.定义全局常量",
                         "23.使用Codable协议解析JSON",
                         "24.dispatch_once替代方案",
                         "25.被废弃的+load()和+initialize()",
                         "26.获取View的指定视图",
                         "27.线程安全:互斥锁和自旋锁",
                         "28.可选类型的扩展",
                         "29.更明了的异常处理封装",
